...
function createOrgs() {
  ...
  while :
    ...
    infoln "Create Transporter Identities"
    createTransporter

    infoln "Create Retailer Identities"
    createRetailer

    infoln "Create Consumer Identities"
    createConsumer
  ...
  infoln "Generate CCP files for Manufacturer, Distributor, Transporter, Retailer and Consumer"
